...
4) Exports information to 3 HTML files
...
<h3>Questions? Concerns?  <a href="mailto:email@email.com?Subject=Privileged Accounts Report for $date" target="_top">Email</a></h3>
"@

$Header_DormantAccounts  =@"
<h3>GCP Report: Dormant AD Accounts (90 Days) as of $date</h3>
<h3>Questions? Concerns?  <a href="mailto:email@email.com?Subject=Dormant Accounts Report for $date" target="_top">Email</a></h3>
"@

$header_SystemAccounts  =@"
<h3>GCP Report: Accounts set to Password Never Expire and not change in over 365 days as of $date</h3>
<h3>Questions? Concerns?  <a href="mailto:email@email.com?Subject=System Accounts Report for $date" target="_top">Email</a></h3>
"@
